...
export default function HomePage() {
  return (
<div className="bg-[#5DC9A8] min-h-screen flex flex-col xl:flex-row items-center justify-center gap-10 px-2">
      <Image
      ...
      <div>
        <h1 className="text-5xl font-test text-balance font-semibold my-6 max-w-[500px]">
